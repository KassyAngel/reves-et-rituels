  ...
  fr: [
    // ─── ÉLÉMENTS / NATURE ───────────────────────────────────────────────────
    {
      keywords: [
        ...
        "sous-marin", "profondeur", "abysses", "coulée"
      ],
    ...
    },
    {
      keywords: [
        ...
        "liberté", "hauteur", "altitude", "décollage", "plume", "planer haut",
        "ascension", "vol libre", "planeur"
      ],
    ...
    },
    {
      keywords: [
        ...
        "dégringoler", "plonger dans le vide"
      ],
    ...
    },
    {
      keywords: [
        ...
        "crémation", "feu de camp", "cheminée", "embrasement"
      ],
    ...
    },
    {
      keywords: [
        ...
        "sécheresse", "steppe", "savane", "terre aride"
      ],
    ...
    },
    {
      keywords: [
        ...
        "forêt tropicale", "mangrove", "taillis"
      ],
    ...
    // ─── SPORT / ACTIVITÉ PHYSIQUE ────────────────────────────────────────────
    {
      keywords: [
        ...
        "défaite sportive", "score", "mi-temps"
      ],
    ...
    },
    {
      keywords: [
        ...
        "ne pas pouvoir courir", "course à pied", "trail"
      ],
    ...
    },
    {
      keywords: [
        ...
        "aquatique", "eau froide", "eau chaude"
      ],
    ...
    {
      keywords: [
        "ski", "skier", "piste", "slalom", "descente", "télésiège",
        "neige", "snowboard", "chalet", "après-ski", "compétition de ski",
        "avalanche", "hors-piste", "virage", "bâtons de ski"
      ],
      interpretation: "Le ski en rêve symbolise la maîtrise face à la vitesse et aux défis. Descendre une piste avec aisance reflète ta confiance à gérer une situation difficile. Une chute sur les pistes invite à revoir ton approche d'un obstacle. Le hors-piste évoque une prise de risque délibérée.",
      image: "/images/iconekeywords/sport.webp"
    },
    {
      keywords: [
        "gym", "musculation", "salle de sport", "haltères", "fitness",
        "abdominaux", "pompes", "squat", "traction", "cardio",
        "tapis de course", "coach sportif", "culturisme", "bodybuilding",
        "force", "muscles", "entraînement", "performance physique"
      ],
      interpretation: "La salle de sport en rêve symbolise un besoin de renforcement intérieur ou de discipline. Soulever des poids évoque la volonté de prendre en charge une responsabilité. Un corps musclé représente la puissance et la confiance en soi. L'épuisement après l'effort annonce une transformation positive en cours.",
      image: "/images/iconekeywords/sport.webp"
    },
    {
      keywords: [
        "yoga", "méditation sportive", "stretching", "souplesse", "pilates",
        "posture", "équilibre", "respiration", "relaxation", "bien-être",
        "tapis de yoga", "chakra sportif", "harmonie corps esprit"
      ],
      interpretation: "Le yoga en rêve invite à l'équilibre entre corps et esprit. Une posture difficile à tenir symbolise un aspect de ta vie qui demande plus de patience. La souplesse en rêve reflète ta capacité d'adaptation. La respiration consciente t'invite à ralentir et à revenir à l'essentiel.",
      image: "/images/iconekeywords/sport.webp"
    },
    {
      keywords: [
        "rugby", "ballon ovale", "mêlée", "essai", "plaquage",
        "terrain de rugby", "équipe de rugby", "XV de france", "touche",
        "conquête", "pack", "troisième mi-temps"
      ],
      interpretation: "Le rugby symbolise la force collective, la résistance et la solidarité. Un plaquage en rêve évoque une confrontation brutale avec la réalité. Marquer un essai représente l'aboutissement d'un effort collectif. La mêlée reflète une situation complexe où plusieurs forces s'affrontent.",
      image: "/images/iconekeywords/sport.webp"
    },
    {
      keywords: [
        "escalade", "grimper", "mur d'escalade", "voie", "cordée",
        "harnais", "mousqueton", "bloc", "bouldering", "paroi rocheuse",
        "prise", "sommet à atteindre", "vertige", "corde"
      ],
      interpretation: "L'escalade en rêve symbolise l'ambition et la volonté de s'élever. Chaque prise représente une petite victoire sur le chemin vers ton objectif. Le vertige face à la paroi reflète l'appréhension devant un défi. Atteindre le sommet annonce une réussite après un effort soutenu.",
      image: "/images/iconekeywords/sport.webp"
    },
    {
      keywords: [
        "golf", "balle de golf", "fairway", "putting", "green", "birdie",
        "eagle", "trou", "club de golf", "parcours", "caddie",
        "swing", "handicap sportif"
      ],
      interpretation: "Le golf en rêve symbolise la précision, la patience et la maîtrise de soi. Un beau swing reflète une action bien calibrée dans ta vie. Rater le trou invite à affiner ta stratégie. Le parcours de golf représente le chemin de vie avec ses obstacles et ses récompenses.",
      image: "/images/iconekeywords/sport.webp"
    },
    {
      keywords: [
        "jeux olympiques", "olympique", "médaille d'or", "médaille d'argent",
        "médaille de bronze", "podium", "cérémonie", "flamme olympique",
        "athlète", "champion olympique", "record du monde", "compétition internationale"
      ],
      interpretation: "Les Jeux olympiques en rêve symbolisent la quête de l'excellence et la reconnaissance mondiale. Monter sur le podium représente l'accomplissement d'un grand objectif. La flamme olympique évoque l'idéal, l'aspiration et la transmission. Ce rêve t'invite à viser haut et à donner le meilleur de toi-même.",
      image: "/images/iconekeywords/sport.webp"
    },
    ...
    {
      keywords: [
        "famille", "père", "mère", "frère", "sœur", "parents", "grands-parents",
        "oncle", "tante", "cousin", "enfant", "fils", "fille", "mari", "femme",
        "conjoint", "belle-famille", "foyer", "maison familiale", "réunion de famille",
        "héritage", "ancêtres", "généalogie", "fratrie", "aîné", "benjamin",
        "parent décédé", "famille recomposée"
      ],
    ...
    },
    {
      keywords: [
        ...
        "testament", "succession", "disparaître"
      ],
    ...
    // ─── TECHNOLOGIE / NUMÉRIQUE ──────────────────────────────────────────────
    {
      keywords: [
        ...
        "cybersécurité", "hacker", "panne informatique"
      ],
    ...
    },
    {
      keywords: [
        ...
        "portable", "recharge", "batterie vide"
      ],
    ...
    {
      keywords: [
        "jeu vidéo", "jeux", "console", "manette", "game over", "level up",
        "boss final", "personnage", "avatar", "monde virtuel", "réalité virtuelle",
        "vie supplémentaire", "score", "quête", "mission", "ps5", "xbox",
        "nintendo", "fortnite", "minecraft"
      ],
      interpretation: "Les jeux vidéo en rêve symbolisent ta façon d'aborder les défis de la vie. Un game over reflète une peur de l'échec ou la fin d'une tentative. Passer au niveau suivant représente une progression personnelle. Le personnage que tu incarnes révèle une facette de toi que tu explores. La quête inachevée évoque un objectif laissé en suspens.",
      image: "/images/iconekeywords/telephone.webp"
    },
    {
      keywords: [
        "réseaux sociaux", "instagram", "facebook", "tiktok", "youtube",
        "like", "follower", "commentaire", "viral", "influenceur",
        "photo publiée", "story", "selfie", "profil", "abonné",
        "notification", "partager", "algorithme", "buzz"
      ],
      interpretation: "Les réseaux sociaux en rêve reflètent ton rapport à l'image de soi et au regard des autres. Un like ou une validation massive évoque un besoin de reconnaissance. Être ignoré ou avoir peu d'abonnés traduit une peur du rejet ou de la invisibilité sociale. Un compte piraté symbolise une violation de ton intimité ou de ton identité.",
      image: "/images/iconekeywords/telephone.webp"
    },
    ...
    },
    {
      ...
      interpretation: "Le chat symbolise l'indépendance, l'intuition et le mystère. Un chat noir n'est pas néfaste — il représente souvent l'intuition et les pouvoirs cachés. Un chat qui ronronne évoque la satisfaction et le bien-être. Un chat qui griffe indique qu'une relation apparemment douce cache une tension. Le chat est aussi lié au féminin sacré et à la magie.",
      image: "/images/iconekeywords/animal.webp"
    },
    {
      keywords: [
      ...
      interpretation: "Le cheval symbolise la liberté, la puissance et l'énergie vitale. Galoper librement annonce une période d'expansion et d'élan. Un cheval blanc représente la pureté et la guidance spirituelle. Un cheval incontrôlable évoque des instincts ou des émotions difficiles à maîtriser. Tomber de cheval invite à examiner ce qui te fait perdre le contrôle.",
      image: "/images/iconekeywords/animal.webp"
    },
    ...
    },
    {
      keywords: [
        ...
        "corps dénudé", "intimité dévoilée"
      ],
    ...
    // ─── VIE PERSONNELLE / PSYCHOLOGIQUE ─────────────────────────────────────
    {
      keywords: [
        ...
        "partir à l'étranger", "expatriation"
      ],
  ...
  en: [
    ...
    },
    {
      keywords: [
        ...
        "lose balance", "hole", "descent", "plunge"
      ],
    ...
    {
      keywords: [
        "cycling", "bike", "bicycle", "pedal", "mountain bike", "road bike",
        "tour de france", "chain", "gears", "downhill", "uphill cycling",
        "brakes", "cyclist", "wheel", "handlebar"
      ],
      interpretation: "Cycling in a dream represents your life balance and progress at your own pace. Pedaling uphill symbolizes effort needed to face an obstacle. A free downhill ride evokes letting go and flow. A broken chain or faulty brakes signal that a mechanism in your life needs attention.",
      image: "/images/iconekeywords/sport.webp"
    },
    {
      keywords: [
        "skiing", "ski", "slope", "slalom", "downhill", "chairlift",
        "snowboard", "chalet", "ski resort", "moguls", "off-piste",
        "turn", "ski poles", "ski competition"
      ],
      interpretation: "Skiing in a dream symbolizes mastery in the face of speed and challenges. Going down a slope with ease reflects your confidence in handling difficult situations. A fall on the slopes invites you to revisit your approach to an obstacle.",
      image: "/images/iconekeywords/sport.webp"
    },
    {
      keywords: [
        "gym", "workout", "weight training", "dumbbells", "fitness",
        "abs", "push ups", "squat", "pull up", "cardio",
        "treadmill", "personal trainer", "bodybuilding", "strength",
        "muscles", "training", "physical performance", "lifting weights"
      ],
      interpretation: "The gym in dreams symbolizes a need for inner strengthening or discipline. Lifting weights evokes the will to take on a responsibility. A muscular body represents power and self-confidence. Exhaustion after effort announces a positive transformation underway.",
      image: "/images/iconekeywords/sport.webp"
    },
    {
      keywords: [
        "yoga", "stretching", "flexibility", "pilates", "posture",
        "balance", "breathing", "relaxation", "wellness", "yoga mat",
        "mindfulness", "mind body harmony", "meditation"
      ],
      interpretation: "Yoga in dreams invites balance between body and mind. A difficult pose to hold symbolizes an aspect of your life requiring more patience. Flexibility in a dream reflects your adaptability. Conscious breathing invites you to slow down and return to the essentials.",
      image: "/images/iconekeywords/sport.webp"
    },
    {
      keywords: [
        "olympic games", "olympics", "gold medal", "silver medal",
        "bronze medal", "podium", "ceremony", "olympic flame",
        "athlete", "olympic champion", "world record", "international competition"
      ],
      interpretation: "The Olympic Games in dreams symbolize the pursuit of excellence and worldwide recognition. Standing on the podium represents accomplishing a major goal. The Olympic flame evokes ideals, aspiration and legacy. This dream invites you to aim high and give your very best.",
      image: "/images/iconekeywords/sport.webp"
    },
    ...
    {
      keywords: [
        "family", "father", "mother", "brother", "sister", "parents",
        "grandparents", "uncle", "aunt", "cousin", "child", "son",
        "daughter", "husband", "wife", "spouse", "in-laws", "home",
        "family home", "family reunion", "inheritance", "ancestors", "genealogy",
    ...
    },
    {
      keywords: [
        ...
        "like", "follower", "comment", "viral", "influencer",
        "post", "story", "selfie", "profile", "subscriber",
        "notification", "share", "algorithm", "trending"
      ],
      interpretation: "Social media in dreams reflects your relationship with self-image and others' perceptions. Massive likes or validation evoke a need for recognition. Being ignored or having few followers expresses a fear of rejection or social invisibility. A hacked account symbolizes a violation of your privacy or identity.",
      image: "/images/iconekeywords/telephone.webp"
    },
    ...
    },
    {
      ...
      interpretation: "The cat symbolizes independence, intuition and mystery. A black cat represents intuition and hidden powers — not bad luck. A purring cat evokes satisfaction and well-being. A scratching cat indicates that an apparently gentle relationship hides tension. The cat is also linked to the sacred feminine and magic.",
      image: "/images/iconekeywords/animal.webp"
    },
    {
      keywords: [
        ...
        "stable", "trot", "canter", "equestrian"
      ],
      interpretation: "The horse symbolizes freedom, power and vital energy. Galloping freely announces a period of expansion and momentum. A white horse represents purity and spiritual guidance. An out-of-control horse evokes instincts or emotions difficult to master. Falling off a horse invites examining what makes you lose control.",
      image: "/images/iconekeywords/animal.webp"
    },
    ...
    },
    {
      keywords: [
        ...
        "spring", "cherry blossom", "nature blooming"
      ],
...
function stem(word: string): string {
  ...
  // Remove common French/English suffixes for better matching
  return word
    .replace(/ation$/, "")
    .replace(/ement$/, "")
    .replace(/ment$/, "")
...
function scoreMatch(categoryKeywords: string[], inputWords: string[], normalizedInput: string): number {
  let score = 0;
  ...
  for (const kw of categoryKeywords) {
    ...
    for (const kwWord of kwWords) {
      ...
      for (const inputWord of inputWords) {
        ...
        // Partial match (one starts with the other, min 4 chars)
...
export const interpretDream = (text: string, lang: 'fr' | 'en') => {
  ...
  const top = scored[0];
  const closeMatches = scored.filter(s => s.score >= top.score * 0.6).slice(0, 3);
